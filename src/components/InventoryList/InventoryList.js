...
//           <div className="title-block__title">Inventory</div>
...
//                         {inventoryItem.warehouse_name}<img src={chevronImg} alt="chevron icon" />
//                       </Link>
//                     </div>
//                     <div className="inventory-block__header mobile-view">
//                       {columnHeaderArray[1]}
...
//                     <div className="inventory-block__inventory-address">
//                       {inventoryItem.address}, {inventoryItem.city}, {inventoryItem.country}
//                     </div>
//                   </div>
...
//                       {columnHeaderArray[2]}
//                     </div>
//                     <div className="inventory-block__inventory-contact-name">
//                       {inventoryItem.contact_name}
//                     </div>

//                     <div className="inventory-block__header mobile-view">
//                       {columnHeaderArray[3]}
//                     </div>
//                     <div className="inventory-block__inventory-contact-info">
//                       <div className="inventory-block__inventory-contact-number">
//                         {inventoryItem.contact_phone}
//                       </div>
//                       <div className="inventory-block__inventory-contact-email">
//                         {inventoryItem.contact_email}
//                       </div>
//                     </div>
//                   </div>
//                 </div>
