          ...
          <div className="warehouse-details">
            <div className="warehouse-details__container">
              <div className="warehouse-details__address-container">
                <h4 className="warehouse-details__address-label">Warehouse Address:</h4>
                <div className="warehouse-details__address-formatting">
                  <p className="warehouse-details__address">{warehouseData.address},</p>
                  <p className="warehouse-details__address">{warehouseData.city}, {warehouseData.country}</p>
                </div>
              </div>
            </div>
            <div className="warehouse-details__contact-container">
              <div className="warehouse-details__name-details">
                ...
                <p className="warehouse-details__name">{warehouseData.contact_name}</p>
                <p className="warehouse-details__position">{warehouseData.contact_position}</p>
              </div>
              <div className="warehouse-details__contact-info">
                <p className="warehouse-details__contact-info-label">Contact Information:</p>
                <p className="warehouse-details__contact-phone">{warehouseData.contact_phone}</p>
                <p className="warehouse-details__contact-email">{warehouseData.contact_email}</p>
              </div>
            </div>
          </div>
        </div>
